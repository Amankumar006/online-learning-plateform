...
export default function NewExercisePage() {
  ...
  const handleGenerateExercises = async () => {
    ...
    try {
        ...
        const results = await generateExercise({ lessonContent });
  ...
  return (
    <div>
        ...
        <Card>
            ...
            <CardDescription>Select a lesson and use AI to generate a varied set of exercises.</CardDescription>
            </CardHeader>
            ...
            <Alert>
                ...
                <AlertDescription className="mb-4">
                    Select a lesson and our AI will generate a diverse set of exercises for you, including Multiple-Choice, True/False, and Long-Form questions.
                </AlertDescription>
                 <div className="flex flex-col sm:flex-row gap-4">
                    <div className="space-y-2 flex-grow">
                     ...
                     <Button type="button" variant="outline" onClick={handleGenerateExercises} disabled={isGenerating || !selectedLessonId} className="shrink-0">
